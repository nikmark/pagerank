 ...
 *
 */
public class PageRankIMCMapper extends Mapper<LongWritable, Node, LongWritable, Node> {
	...
	protected void setup(Mapper<LongWritable,Node,LongWritable,Node>.Context context) throws IOException ,InterruptedException {
	...
	@Override
	protected void cleanup(Mapper<LongWritable, Node, LongWritable, Node>.Context context) 	throws IOException, InterruptedException {
